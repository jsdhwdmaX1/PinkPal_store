  ...
  <div class="main">
    ...
    <div class="Setting">
      <div style="margin-right: 10px;display: flex; align-items: center;justify-content: center">
        <el-avatar src="https://cube.elemecdn.com/0/88/03b0d39583f48206768a7534e55bcpng.png" :fit="'fill'" style="margin-right: 10px"/>
        <el-text style="margin-right: 30px" size="large">{{userStore.getUserInfo().username}}</el-text>
      </div>
